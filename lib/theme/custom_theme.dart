...
class CustomTheme {
  ...
  static const Color primary = Color.fromRGBO(7, 85, 44, 1.0);
  static final Color bg_primary_light = Color.fromRGBO(204, 231, 206, 1.0);
  static Color primaryDark = Color.fromRGBO(7, 85, 44, 1.0);
  ...
  static final Color blue = Color(0xff07552c);
  ...
  static InputDecoration in_3(
    ...
    return InputDecoration(
      ...
      contentPadding: EdgeInsets.only(left: 15, bottom: 0, right: 15, top: 0),
